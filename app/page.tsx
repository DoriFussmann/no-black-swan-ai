      ...
      <main className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Valuation Tools - Moved to top row, far right */}
            <Link href="/valuation-tools" className="block">
              <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 cursor-pointer h-full flex flex-col">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Football Field Valuation</h3>
                <p className="text-gray-600 leading-relaxed flex-grow">
                  Advanced startup valuation with football field charts and multiple methodologies.
                </p>
                <div className="mt-6">
            ...
            {/* Financial Model Builder - Moved to bottom row, far left */}
