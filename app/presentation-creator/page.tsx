        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Presentation <span className="text-orange-400">Creator</span>
            </h1>
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-12 shadow-xl border border-gray-700/50 text-center">
            <div className="w-24 h-24 bg-orange-600 rounded-2xl flex items-center justify-center mx-auto mb-8">
            ...
            <Link 
              href="/"
              className="bg-orange-600 hover:bg-orange-700 text-white font-semibold py-4 px-8 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 text-lg inline-block"
            >
              Back to Home
            </Link>
          </div>
