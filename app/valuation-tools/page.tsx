            ...
            <div className="flex items-center space-x-4">
              <Link href="/" className="flex items-center space-x-4">
                <Image
                  ...
                  priority
                />
                <span className="text-2xl font-bold text-gray-900">Valuation Tools</span>
              </Link>
            </div>
                     ...
                     <div className="flex-1" style={{ minHeight: '420px' }}>
                       <div className="h-full flex flex-col">
                         ...
                         <div className="flex-1 relative">
                           {/* Y-axis labels */}
                           <div className="absolute left-0 top-0 bottom-0 w-32 flex flex-col justify-between">
                             {valuationRanges.map((range, index) => (
                               <div key={index} className="text-sm font-medium text-gray-700 px-2 py-1">
                                 {range.name}
                               </div>
                             ))}
                           </div>
                           ...
                           <div className="ml-32 h-full relative">
                             ...
                             <div className="absolute inset-0 pt-4 pb-12">
                               {valuationRanges.map((range, index) => {
                                 ...
                                 const barHeight = 100 / valuationRanges.length;
                                 const topPosition = (index * barHeight) + (barHeight * 0.1);
                                 const barHeightFinal = barHeight * 0.8;
        ...
        <div className="w-full lg:w-1/2 bg-white">
          <div className="h-full flex flex-col">
             ...
             <div className="p-6 border-b border-gray-200">
               <div className="flex items-center justify-between">
                 <div>
                   <h3 className="text-xl font-bold text-gray-900">Valuation Inputs</h3>
                   <p className="text-gray-600 mt-1">Enter company metrics and valuation parameters</p>
                 </div>
                                   <button
                    onClick={() => {
                      setInputs({
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                         <div>
                       <Tooltip content="Enter the company's annual revenue/sales figure in dollars. This is used to calculate EV/Sales multiples.">
                        ...
                        />
                                         ...
                                         <div>
                       <Tooltip content="Enter the company's EBITDA (Earnings Before Interest, Taxes, Depreciation, and Amortization). This is used to calculate EV/EBITDA multiples.">
                         <label className="block text-sm font-medium text-gray-700 mb-1 cursor-help">
                           Company EBITDA ($)
                         </label>
                       </Tooltip>
                 ...
                 {/* Row 2: Public Comps Combined */}
                 <div className="bg-white rounded-lg border border-gray-200 p-4">
                   <h4 className="font-semibold text-gray-900 mb-4">Public Comparable Companies Multiples</h4>
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                     <div>
                       <label className="block text-sm font-medium text-gray-700 mb-1">
                         EV/Sales (Low)
                 ...
                 {/* Row 3: Precedent Transactions Combined */}
                 <div className="bg-white rounded-lg border border-gray-200 p-4">
                   <h4 className="font-semibold text-gray-900 mb-4">Precedent Transactions Multiples</h4>
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                     <div>
                       <label className="block text-sm font-medium text-gray-700 mb-1">
                         EV/Sales (Low)
